...
#include "graph.hpp"
#define _USE_MATH_DEFINES // чтобы можно было использовать число пи M_PI
#ifndef M_PI // если M_PI до сих пор нет (зависит от компилятора)
#define M_PI 3.14159265358979 // определяем его вручную
#endif
